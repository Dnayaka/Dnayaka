...
| [`gamen-rgb`](https://github.com/dnayaka/gamen-rgb) | RGB keyboard control for unsupported hardware on Linux |

⚠️ **Honesty note:** several repos here are active experiments / work-in-progress, not finished products. If something looks unfinished, it probably is — I iterate in public. Ask me about the current state of anything before relying on it.
